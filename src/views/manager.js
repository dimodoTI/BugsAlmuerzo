  ...
  stateChanged(state, name) {
    if (name == QUEPANTALLA) {
      if (
        ...
        this.shadowRoot.querySelector("#tarjetachiplectura").hidden =
          state.ui.quePantalla != "tarjetachiplectura";
        this.shadowRoot.querySelector("#tarjetachipseleccionimporte").hidden =
          state.ui.quePantalla != "tarjetachipseleccionimporte";
        this.shadowRoot.querySelector(
          "#tarjetachipselecciontarjetacredito"
        ).hidden = state.ui.quePantalla != "tarjetachipselecciontarjetacredito";
        this.shadowRoot.querySelector("#cargatarjetacreditoposnet").hidden =
          state.ui.quePantalla != "cargatarjetacreditoposnet";
        this.shadowRoot.querySelector("#tarjetachiprecargaexito").hidden =
          state.ui.quePantalla != "tarjetachiprecargaexito";

        this.shadowRoot.querySelector("#viandatarjetachiplectura").hidden =
          state.ui.quePantalla != "viandatarjetachiplectura";
        this.shadowRoot.querySelector("#viandaselecciontipomenu").hidden =
          state.ui.quePantalla != "viandaselecciontipomenu";
        this.shadowRoot.querySelector("#viandaseleccionmenu").hidden =
          state.ui.quePantalla != "viandaseleccionmenu";
        this.shadowRoot.querySelector("#viandamenuaceptacion").hidden =
          state.ui.quePantalla != "viandamenuaceptacion";
        this.shadowRoot.querySelector("#viandamenuexito").hidden =
          state.ui.quePantalla != "viandamenuexito";
      }
      this.shadowRoot.querySelector("#fueralinea").hidden =
        state.ui.quePantalla != "fueralinea";
      this.shadowRoot.querySelector("#mensajeespera").hidden =
        state.ui.quePantalla != "mensajeespera";
