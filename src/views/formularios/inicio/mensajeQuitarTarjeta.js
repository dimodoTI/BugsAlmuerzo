...
export class pantallaQuitarTarjeta extends connect(store, MODO_PANTALLA, TARJETA_CHIP)(LitElement) {
    constructor() {
        super();
        this.hidden = true
        this.idioma = "ES"
    ...
    stateChanged(state, name) {
        if (name == MODO_PANTALLA && state.ui.quePantalla == "inicio") {
            this.hidden = !state.tarjetaChip.colocada
            store.dispatch(servicioTC(state.tarjetaChip.colocada))
        }
        if (name == TARJETA_CHIP && state.ui.quePantalla == "inicio") {
            this.hidden = !state.tarjetaChip.colocada
            store.dispatch(servicioTC(state.tarjetaChip.colocada))
        }
    }
...
window.customElements.define("pantalla-quitar-tarjeta", pantallaQuitarTarjeta);